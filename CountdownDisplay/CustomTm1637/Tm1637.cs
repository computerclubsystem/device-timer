...
namespace DeviceTimer.CountdownDisplay.CustomTm1637
{
    /// <summary>
    ...
    public class Tm1637 : Tm16xxI2CLikeBase
    {
        ...
        private const byte ClockWidthMicroseconds = 8;
        ...
        // EDIT: Align to Python sample code - need to override because base implementation is not stable
        private protected override void StartTransmission()
        {
            ...
            // EDIT: Align to Python sample code
            Controller.Write(PinClk, PinValue.Low);
            DelayHelper.DelayMicroseconds(ClockWidthMicroseconds, true);
        }

        // EDIT: Align to Python sample code - need to override because base implementation is not stable
        private protected override void StopTransmission()
        {
        ...
        private protected override PinValue WaitAcknowledge()
        {
            // TODO: The base implementation ruins the communication. Not sure how to fix it so returning "OK" response (PinValue.Low)
            return PinValue.Low;
        }
